    ...
    <div className="bg-app page-fade min-h-screen pb-24 md:pb-10">
      <div className="container mx-auto max-w-6xl px-4 py-10">
        <div className="mb-8">
          ...
          <p className="text-slate-300">Latest market news and sentiment analysis</p>
        </div>
          ...
          <form onSubmit={handleSearch} className="flex gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                placeholder="Search news (e.g., AAPL, tech earnings)"
          ...
          <div className="space-y-6">
            ...
            <div className="glass-panel rounded-3xl p-8">
              <div className="flex items-center gap-3 mb-6">
                <Newspaper className="text-yellow-400" size={32} />
              ...
              <div className="glass-panel rounded-3xl p-8">
                ...
                <div className="space-y-4">
                  {result.steps.map((step, index) => (
                    <div key={index} className="rounded-2xl bg-black/35 p-4 border-l-4 border-amber-400">
                      <div className="text-sm font-semibold text-amber-300 mb-2">Step {index + 1}</div>
